...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getDetail: function getDetail(slug, index) {
      ...
      axios.get('/api/cars/' + slug).then(function (response) {
        // console.log(response.data);
        _this.cars[index].detail = response.data;
        console.log(_this.cars[index], 'detail');
      });
    }
  },
            ...
            "a",
            {
              ...
              on: {
                click: function ($event) {
                  return _vm.getDetail(car.slug, index)
                },
              },
            },
